...
I remember when I first heard about '*productivity*' from a popular YouTuber, [Ali Abdaal](https://www.youtube.com/@aliabdaal). I was immediately hooked to his content, and I started following his advice to improve my '*productivity*'. It was exciting to see that I could be as successful as *Ali* was, even though our definitions of success were very different. However, I struggled with it because the results were not as promising as he claimed.
...
Then one day I heard about a book **The Burnout Society** by a philosopher *Byung-Chul Han* from one and only [Einzelganger](https://einzelganger.co). *Han* claimed a very interesting transition of society from work-driven to self-driven. In the former case, people were working because they needed to and not because they were only passionate about it. It does not mean that they were not working hard, but they need an external force (or reason) to work. *Han* referred them as **disciplinary society**.
