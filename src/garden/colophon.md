...
<h3>Last updated at {{ date | postDate }}</h3>

**In progress**

After switching many platforms, this blog is currently built on ~~[PyBlosxom](http://pyblosxom.github.io/)~~ ~~[Aurora](https://github.com/capjamesg/aurora?tab=readme-ov-file)~~ [11ty](). The main recipe includes HTML+CSS+JS codes.
